package com.pachanga.appdeposit.message;
...
public class TransactionMessagePublish {
    ...
    public ListenableFuture<SendResult<Integer, String>> sendDepositEvent(TransactionModel transactionModel) throws JsonProcessingException {
