package com.pachanga.appwithdrawal.message;
...
public class TransactionMessagePublish {
    ...
    public ListenableFuture<SendResult<Integer, String>> sendDepositEvent(WithdrawalModel transactionModel) throws JsonProcessingException {
